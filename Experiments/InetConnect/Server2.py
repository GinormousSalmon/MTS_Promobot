...
def video_from_robot():
    global frame_byte, frame_json, flag_stop_video, flag_video_demon_work
    # видео клиент. берет кадры с запущенного робота
...
# async \
def run_subprocess():
    global process, console_out, filename
    # global slave
